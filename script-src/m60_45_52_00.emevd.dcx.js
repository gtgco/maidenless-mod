...
// === Maidenless patch begin ===
// Open Leyndell gate after ≥2 Great Runes (no Roundtable spoofing)
$Event(20000721, Restart, function () {
    // Great-rune-derived counters in vanilla
    WaitFor(EventFlag(181) || EventFlag(182));
    DisplayBanner(TextBannerType.DutyFulfilled);
    // The gate pieces used by the Leyndell entrance block
